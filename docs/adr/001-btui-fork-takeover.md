...
- [x] **Release vs personal audit**: goreleaser clean (correct owner/module/binary). Version numbering decided: v0.1.0 reset. `.beads/` dogfood data intentionally tracked. (session 5)
