...
- **Report**: `docs/audits/domain/2026-04-03-test-suite-audit.md`
...
- **Reports**: 10 team files now in `docs/archive/audits/` (teams 1a, 1b, 2, 3, 4, 5, 6, 7, 8a, 8b)
- **Architecture map**: `docs/audits/architecture/2026-03-16-architecture-map.md` - cross-domain dependency graph + findings synthesis
...
- **Docs**: brainstorm at `docs/brainstorms/2026-04-01-bql-import.md`, plan at `docs/plans/2026-04-01-feat-bql-import-composable-search.md`
