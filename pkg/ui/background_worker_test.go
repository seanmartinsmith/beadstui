...
func TestBackgroundWorker_NewWithoutPath_EnvDefaults(t *testing.T) {
	t.Setenv("BT_DEBOUNCE_MS", "123")
	t.Setenv("BT_CHANNEL_BUFFER", "3")
	t.Setenv("BT_HEARTBEAT_INTERVAL_S", "9")
	t.Setenv("BT_WATCHDOG_INTERVAL_S", "11")
