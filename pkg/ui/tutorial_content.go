...
func structuredTutorialPages() []StructuredTutorialPage {
	return []StructuredTutorialPage{
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				Section{Title: "Welcome to beadstui"},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyBinding{
					{Key: "/", Desc: "Open search bar"},
					{Key: "Ctrl+S", Desc: "Cycle mode: fuzzy → hybrid → semantic"},
					{Key: "H", Desc: "Cycle hybrid preset (only in hybrid mode)"},
					{Key: `"foo bar"`, Desc: "Exact phrase (substring match)"},
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyBinding{
					...
					{Key: "Ctrl+S", Desc: "Cycle mode: fuzzy → hybrid → semantic"},
					{Key: "H", Desc: "Cycle hybrid preset (only in hybrid mode)"},
					{Key: `"foo bar"`, Desc: "Exact phrase match"},
				}},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyBinding{
					{Key: "bt", Desc: "Interactive TUI for humans"},
					{Key: "--robot-*", Desc: "JSON output for agents"},
				}},
				Spacer{Lines: 1},
				Section{Title: "Key Robot Commands"},
				Code{Text: "bt --robot-triage  # The mega-command\nbt --robot-next    # Single top priority\nbt --robot-plan    # Parallel execution\nbt --robot-alerts  # Stale, inversions"},
				Spacer{Lines: 1},
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyBinding{
					{Key: "/", Desc: "Open search bar"},
					{Key: "Ctrl+S", Desc: "Cycle search mode"},
					{Key: "H", Desc: "Cycle hybrid preset"},
					{Key: `"foo bar"`, Desc: "Exact phrase match"},
